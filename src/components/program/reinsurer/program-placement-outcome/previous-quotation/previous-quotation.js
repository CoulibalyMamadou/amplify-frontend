...
const PreviousQuotation = ({ quotation, program, reinsurer }) => {
	/**
	 * Quotation list
	 */
	...
	const quotationArray =
		...
		reinsurerQuotation.map((elem) => {
			return elem.previousQuotation?.quotations
		})
...
PreviousQuotation.propTypes = {
	quotation: PropTypes.array,
	program: PropTypes.object,
	reinsurer: PropTypes.object
}

export default PreviousQuotation
